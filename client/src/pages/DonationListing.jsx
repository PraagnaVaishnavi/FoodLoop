        ...
        <div className="flex flex-wrap gap-2">
          {donation.tags &&
            donation.tags.map((tag, idx) => (
              <span
                key={idx}
                className={`text-xs px-3 py-1 rounded-full font-semibold transition-all duration-300 hover:scale-105 ${getTagColor(
                  tag
                )}`}
              >
                {tag}
...
const DonationList = () => {
  const userRole = "NGO"; // hardcoded for demo
  ...
  const sampleDonations = [
    {
      ...
      description:
        "Fresh hot meals prepared with love and care. Please claim quickly as these items are highly perishable.",
    },
    {
      _id: "2",
      images: ["./card3.png"],
  ...
  const dataToRender = donations.length > 0 ? donations : sampleDonations;
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden">
        ...
        <div
          className="absolute top-1/2 right-32 w-32 h-32 bg-gradient-to-r from-purple-200/15 to-pink-200/15 rounded-full blur-xl animate-bounce"
          style={{ animationDuration: "4s" }}
        ></div>
        <div
          className="absolute bottom-32 left-1/3 w-48 h-48 bg-gradient-to-r from-indigo-200/20 to-blue-200/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 flex w-full min-h-screen font-sans">
        {/* Sidebar */}
        <div className="h-1000px w-15 backdrop-blur-md border-r border-gray-200/50 shadow-xl ">
          ...
          <div className="relative px-6 py-8 sm:px-8 lg:px-12">
            <div className="max-w-7xl mx-auto text-center">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200/50 inline-block transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-lg text-gray-600 font-medium">Discover and claim food donations in your area</p>
              </div>
            </div>
          </div>
